...
export default function BusinessOverlook() {
  ...
  return (
    <div className="w-full h-screen bg-slate-50 flex items-center justify-center relative">
      <div className="absolute top-6 left-6 flex items-center gap-4">
        <div className="bg-indigo-600 text-white font-black px-4 py-2 rounded-xl shadow-lg">
          BUSINESS OVERLOOK
        </div>
      ...
      <div className="text-center max-w-lg mx-auto">
        <h1 className="text-3xl font-black text-slate-900 mb-2">GPS Map Canvas</h1>
